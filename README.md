...
<a href="https://play.google.com/store/apps/details?id=com.xray.ang">
...
#### Geoip and Geosite
- geoip.dat and geosite.dat files are in `Android/data/com.xray.ang/files/assets` (path may differ on some Android device)
